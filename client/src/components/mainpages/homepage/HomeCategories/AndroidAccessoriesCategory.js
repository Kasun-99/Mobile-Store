...
import './Categories.css'
 ...
 const AndroidAccessoriesCategory = () => {

    const [filterItems,  setFilterItems] =useState([])
    const [filterCategory,setFilterCategory] = useState("615490657c7fea64cc7f0323")
...
export default AndroidAccessoriesCategory